...
def extract_level(in_df):
    ...
    for r in range(n_rows):
        ...
        d_vals = in_data.iloc[r, 17:48].values
        d_dates = [datetime(row_year, row_month, day) for day in range(1, 32)]
...
for f in in_files:
    ...
    plt.plot(st_data['dt'], st_data['level_cm'])
    plt.show()
