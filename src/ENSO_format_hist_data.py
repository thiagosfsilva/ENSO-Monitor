...
precData = pd.read_csv('..data/cotas_C_12351000_daily.csv').rename(columns={'dt':'Dt','precip':'Nivel'})
precData['Dt'] = pd.to_datetime(precData['Dt'])
precData['Doy'] = precData['Dt'].dt.dayofyear
precData['Yr'] = pd.to_datetime(precData['Dt']).dt.year
